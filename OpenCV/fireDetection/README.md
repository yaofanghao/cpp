...
* 实现了对火焰图像圆形度、偏心率、熵值等特征值的计算 -2022.11.21
* 实现了串口通信 -2022.11.22 
  * 详见cpp/serial_demo文件夹
* 实现了将火焰特征值保存到csv/excel文件中 -2022.11.24
* 修改为每隔flag帧处理一次图像，减少计算量（抽帧处理） -2022.11.24  
* 制作其他干扰对照组特征值的数据集 -2022.11.27

## 待完成内容
* 制作火焰特征数据集
* 将火焰和干扰项数据集整理为符合SVM训练格式的txt文件
