...
// general settings
std::string video_name = "sg.mp4";
std::string csv_name = "sg.csv";
int area_low = 1000;

//int hl = 0, hh = 50, sl = 0, sh = 80, vl = 250, vh = 255; 

// 30m火焰
//int hl = 10, hh = 30, sl = 100, sh = 200, vl = 250, vh = 255;

// 瓶子 
//int hl = 15, hh = 25, sl = 110, sh = 150, vl = 170, vh = 255;

// 气球
//int hl = 10, hh = 40, sl = 50, sh = 200, vl = 180, vh = 230;

// 大灯
//int hl = 0, hh = 40, sl = 0, sh = 40, vl = 250, vh = 255;

// 闪光灯
int hl = 0, hh = 100, sl = 0, sh = 70, vl = 200, vh = 255;
...
int main(int argc, char** argv)
{
	...
	while (1)
	{
		...
		frame = frame(Range(200, 800), Range(300, 1000)); // Slicing to crop the image
