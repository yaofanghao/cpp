...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actThread_Run->setObjectName("actThread_Run");
        QIcon icon1;
        ...
        actDice_Run->setObjectName("actDice_Run");
        ...
        actDice_Pause->setObjectName("actDice_Pause");
        ...
        actThread_Quit->setObjectName("actThread_Quit");
