...
#run
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:${PADDLE_LITE_DIR}/libs/${TARGET_ARCH_ABI} ./yolo_detection_demo ../models/SegFastscnn/modelFastscnn.nb ../images/test.jpg ./result.png