...
{
	LCD_Clear(WHITE);	//清屏	
	LCD_DrawLine(lcddev.width/2,0,lcddev.width/2,lcddev.height);
	
	//实时界面
	LCD_ShowString(50,10,200,16,16,"CURRENT ADC VALUE");
	LCD_ShowString(10,50,200,16,16,"ADC_CH00:    mV");
  LCD_ShowString(10,70,200,16,16,"ADC_CH01:    mV");
	LCD_ShowString(10,90,200,16,16,"ADC_CH02:    mV");
  LCD_ShowString(10,110,200,16,16,"ADC_CH03:    mV");
  LCD_ShowString(10,130,200,16,16,"ADC_CH04:    mV");
	LCD_ShowString(10,150,200,16,16,"ADC_CH05:    mV");
	LCD_ShowString(10,170,200,16,16,"ADC_CH06:    mV");
	LCD_ShowString(10,190,200,16,16,"ADC_CH07:    mV");
	
	LCD_ShowString(30,410,200,16,16,"STATISTICS INFORMATION");
	LCD_ShowString(10,450,200,16,16,"Low Alarm Number:");
	LCD_ShowString(10,470,200,16,16,"High Alarm Number:");
	
	LCD_ShowString(100,550,200,16,16,"TIME");
	
	//菜单界面
	LCD_ShowString(350,10,200,16,16,"MENU");
}

//显示数据时间函数
void Display_Save_Time(u8 *Time,u16 x,u16 y)
{
	LCD_ShowString(x,y,64,16,16,"  :  :  ");//显示标注	
	LCD_ShowxNum(x,y,Time[0],2,16,0);				//显示时
	LCD_ShowxNum(x+3*8,y,Time[1],2,16,0);		//显示分
	LCD_ShowxNum(x+6*8,y,Time[2],2,16,0);		//显示秒
}
